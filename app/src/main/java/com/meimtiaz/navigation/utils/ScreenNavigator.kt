...
import com.meimtiaz.navigation.activities.DesignNavigationNavHostActivity
...
fun Activity.navigateDesignNavigationNavHostActivity() {
    startActivity(
        Intent(this, DesignNavigationNavHostActivity::class.java)
    )
}
